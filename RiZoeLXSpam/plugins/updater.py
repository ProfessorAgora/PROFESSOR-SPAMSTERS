...
OFFICIAL_UPSTREAM_REPO = "https://github.com/Agora-OS/PROFESSOR-SPAMSTERS"
BOT_IS_UP_TO_DATE = "**Professor Spamsters** is up-to-date sur."
NEW_BOT_UP_DATE_FOUND = (
    "new update found for {branch_name}\n"
    "changelog: \n\n{changelog}\n"
    "updating your Professor Spamsters..."
)
...
async def restart(e):
    if e.sender_id in SUDO_USERS:
        text = "__U𝗽𝗱𝗮𝘁𝗶𝗻𝗴..... 𝗬𝗼𝘂𝗿 𝗣𝗥𝗢𝗙𝗘𝗦𝗦𝗢𝗥 𝗦𝗣𝗔𝗠𝗦𝗧𝗘𝗥𝗦__\n𝗧𝘆𝗽𝗲 .ping 𝗔𝗳𝘁𝗲𝗿 5𝗺𝗶𝗻𝘀 𝗧𝗼 𝗰𝗵𝗲𝗰𝗸 𝗜'𝗺 𝗼𝗻 !!"
...
async def deploy_start(Riz, message, refspec, remote):
    ...
    await message.edit(
        "Updated your Professor Spamsters successfully sur!!!\n© @Agoraswamy_Professor"
    )
